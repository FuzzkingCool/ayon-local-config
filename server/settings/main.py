...
class LocalConfigSettingModel(BaseSettingsModel):
    ...
    type: str = SettingsField(
        ...
        enum_resolver=lambda: [
            {
                "value": "string",
                "label": "Text Field - For text input, paths, and custom values",
            },
            {
                "value": "boolean",
                "label": "Checkbox - For toggle switches and enable/disable options",
            },
            {
                "value": "enum",
                "label": "Dropdown - For predefined choices and categories",
            },
            {
                "value": "button",
                "label": "Action Button - For executing actions and workflows",
            },
            {
                "value": "spinbox",
                "label": "Spin Box - For numeric values with specific ranges",
            },
            {
                "value": "divider",
                "label": "Divider - For visual organization and section breaks",
            },
        ],
    )
    ...
    divider_orientation: str = SettingsField(
        ...
        enum_resolver=lambda: [
            {
                "value": "horizontal",
                "label": "Horizontal - Creates section breaks with optional labels",
            },
            {
                "value": "vertical",
                "label": "Vertical - Creates column separators for multi-column layouts",
            },
        ],
